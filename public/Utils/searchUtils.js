...
const { createHomepageUtils } = require('./homePage.js');
const { debouncedFunction } = require('./sharedUtils.js');

const createSearchUtils = (_$w, filterProfiles) => {
  const { getAndSetUserLocation, getParamsMapping, paginateSearchResults, handleNumberOfResults } =
