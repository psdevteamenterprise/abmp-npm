...
interface DataPermissions {
     ...
     *
     * > **Note:** Special permissions override collection-level permissions ([SDK](ADDLINK) | [REST](ADDLINK)).
     * @readonly
     * @maxSize 1000
     */
 ...
 */
declare function updatePermissions(dataPermissions: NonNullablePaths<DataPermissions, `_id` | `itemInsert` | `itemRead` | `itemRemove` | `itemUpdate`, 2>): Promise<NonNullablePaths<UpdatePermissionsResponse, `dataPermissions._id` | `dataPermissions.itemRead` | `dataPermissions.itemInsert` | `dataPermissions.itemUpdate` | `dataPermissions.itemRemove` | `dataPermissions.specialPermissions` | `dataPermissions.specialPermissions.${number}.userId` | `dataPermissions.specialPermissions.${number}.policyId` | `dataPermissions.specialPermissions.${number}._id` | `dataPermissions.specialPermissions.${number}.itemRead` | `dataPermissions.specialPermissions.${number}.itemInsert` | `dataPermissions.specialPermissions.${number}.itemUpdate` | `dataPermissions.specialPermissions.${number}.itemRemove`, 5> & {
 ...
 * @param specialPermissions - Special permissions to grant to the user or role for the specified collection.
 * @public
 * @documentationMaturity preview
 * @requiredField dataCollectionId
 ...
 */
declare function getMyPermissions(dataCollectionId: string): Promise<NonNullablePaths<GetMyPermissionsResponse, `itemRead` | `itemInsert` | `itemUpdate` | `itemRemove`, 2> & {
