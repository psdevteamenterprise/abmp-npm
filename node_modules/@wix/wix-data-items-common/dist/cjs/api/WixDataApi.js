...
var _WixDataAggregatePipelineImpl = require("./impl/WixDataAggregatePipelineImpl");
...
class WixDataApi {
  constructor(clientFactory, allowGet, environment, gridAppId, tracer) {
    ...
    (0, _defineProperty2.default)(this, "aggregatePipeline", (collectionName, pipeline) => {
      return new _WixDataAggregatePipelineImpl.WixDataAggregatePipelineImpl(collectionName, pipeline, this.client);
    });
    // --- bulk methods ---
