...
// src/data-v2-index-indexes.meta.ts
function createIndex2() {
  const payload = {};
  const getRequestOptions = createIndex(payload);
...
function dropIndex2() {
  const payload = {};
  const getRequestOptions = dropIndex(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
function listIndexes2() {
  const payload = {};
  const getRequestOptions = listIndexes(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
function listAvailableIndexes2() {
  const payload = {};
  const getRequestOptions = listAvailableIndexes(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
export {
  ...
  dropIndex2 as dropIndex,
  listAvailableIndexes2 as listAvailableIndexes,
  listIndexes2 as listIndexes
};
