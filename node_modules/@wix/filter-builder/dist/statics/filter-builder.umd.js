...
__webpack_require__.d(__webpack_exports__, {
  Validator: () => (/* reexport */ FilterValidator),
...
return new this.constructor({...this,filterTree,invalidArguments});}_filterValidator(filterOperatorName){return new FilterValidator(filterOperatorName,this.invalidArguments,this.constructor);}};};function isConjunctiveFormFilter(filterTree){return isArray(filterTree.$and);}function isEmptyObject(obj){return Object.keys(obj).length===0;}function inAnd(){for(var _len10=arguments.length,args=new Array(_len10),_key10=0;_key10<_len10;_key10++){args[_key10]=arguments[_key10];}return{$and:args};}function inAndOptimized(){for(var _len11=arguments.length,args=new Array(_len11),_key11=0;_key11<_len11;_key11++){args[_key11]=arguments[_key11];}return{$and:args.reduce((aggr,val)=>isConjunctiveFormFilter(val)?aggr.concat(val.$and):aggr.concat([val]),[])};}function isEmptyAnd(node){return node&&node.$and&&node.$and.length===0;}/* harmony default export */ const filter_mixin = (filterMixin);
;// ./filter-builder.ts
