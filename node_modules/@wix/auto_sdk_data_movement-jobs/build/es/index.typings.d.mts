 ...
 */
declare function createFileUploadUrl(options?: CreateFileUploadUrlOptions): Promise<NonNullablePaths<CreateFileUploadUrlResponse, `fileId` | `uploadUrl`, 2>>;
 ...
 */
declare function listMovementLogs(jobId: string, options?: ListMovementLogsOptions): Promise<NonNullablePaths<ListMovementLogsResponse, `logs` | `logs.${number}.sourceItemId` | `logs.${number}.failure.code` | `logs.${number}.failure.description`, 5>>;
