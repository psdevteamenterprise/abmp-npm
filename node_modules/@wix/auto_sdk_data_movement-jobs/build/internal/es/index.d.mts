...
interface SubmitJobSignature {
     ...
     */
    (source: NonNullablePaths<Source, `file.fileId` | `localization.languages` | `wixDataCollection.collectionId`, 3>, destination: NonNullablePaths<Destination, `file.format` | `localization.languages` | `wixDataCollection.collectionId`, 3>, options?: SubmitJobOptions): Promise<NonNullablePaths<SubmitJobResponse, `job.partiallySuccessfulOptions.cause` | `job._id` | `job.status` | `job.source.wixDataCollection.collectionId` | `job.source.wixDataCollection.fields` | `job.source.localization.languages` | `job.source.file.format` | `job.source.file.fileId` | `job.source.file.url` | `job.destination.wixDataCollection.collectionId` | `job.destination.wixDataCollection.writePolicy` | `job.destination.localization.languages` | `job.destination.file.format` | `job.destination.file.url` | `job.name` | `job.progress.current` | `job.progress.itemsRejected` | `job.progress.itemsSuccessful` | `job.error.code` | `job.error.description` | `job.sourceSiteId` | `job.destinationSiteId` | `job.logsRecorded`, 5>>;
}
...
interface CreateFileUploadUrlSignature {
     ...
     */
    (options?: CreateFileUploadUrlOptions): Promise<NonNullablePaths<CreateFileUploadUrlResponse, `fileId` | `uploadUrl`, 2>>;
}
...
interface ListJobsSignature {
     ...
     */
    (options?: ListJobsOptions): Promise<NonNullablePaths<ListJobsResponse, `jobs` | `jobs.${number}.partiallySuccessfulOptions.cause` | `jobs.${number}._id` | `jobs.${number}.status` | `jobs.${number}.source.wixDataCollection.collectionId` | `jobs.${number}.source.file.format` | `jobs.${number}.source.file.fileId` | `jobs.${number}.source.file.url` | `jobs.${number}.destination.wixDataCollection.collectionId` | `jobs.${number}.destination.wixDataCollection.writePolicy` | `jobs.${number}.destination.file.format` | `jobs.${number}.destination.file.url` | `jobs.${number}.name` | `jobs.${number}.progress.current` | `jobs.${number}.progress.itemsRejected` | `jobs.${number}.progress.itemsSuccessful` | `jobs.${number}.error.code` | `jobs.${number}.error.description` | `jobs.${number}.sourceSiteId` | `jobs.${number}.destinationSiteId` | `jobs.${number}.logsRecorded`, 6>>;
}
...
interface TerminateJobSignature {
     ...
     */
    (jobId: string): Promise<NonNullablePaths<TerminateJobResponse, `job.partiallySuccessfulOptions.cause` | `job._id` | `job.status` | `job.source.wixDataCollection.collectionId` | `job.source.wixDataCollection.fields` | `job.source.localization.languages` | `job.source.file.format` | `job.source.file.fileId` | `job.source.file.url` | `job.destination.wixDataCollection.collectionId` | `job.destination.wixDataCollection.writePolicy` | `job.destination.localization.languages` | `job.destination.file.format` | `job.destination.file.url` | `job.name` | `job.progress.current` | `job.progress.itemsRejected` | `job.progress.itemsSuccessful` | `job.error.code` | `job.error.description` | `job.sourceSiteId` | `job.destinationSiteId` | `job.logsRecorded`, 5>>;
}
...
interface ListMovementLogsSignature {
     ...
     */
    (jobId: string, options?: ListMovementLogsOptions): Promise<NonNullablePaths<ListMovementLogsResponse, `logs` | `logs.${number}.sourceItemId` | `logs.${number}.failure.code` | `logs.${number}.failure.description`, 5>>;
}
