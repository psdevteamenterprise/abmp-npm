...
// src/data-v2-data-collection-collections.meta.ts
function createDataCollection2() {
  const payload = {};
  const getRequestOptions = createDataCollection(payload);
...
function getDataCollection2() {
  const payload = { dataCollectionId: ":dataCollectionId" };
  const getRequestOptions = getDataCollection(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
function listDataCollections2() {
  const payload = {};
  const getRequestOptions = listDataCollections(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
function updateDataCollection2() {
  const payload = {};
  const getRequestOptions = updateDataCollection(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
function deleteDataCollection2() {
  const payload = { dataCollectionId: ":dataCollectionId" };
  const getRequestOptions = deleteDataCollection(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
function restoreDataCollection2() {
  const payload = { dataCollectionId: ":dataCollectionId" };
  const getRequestOptions = restoreDataCollection(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
function createDataCollectionField2() {
  const payload = {};
  const getRequestOptions = createDataCollectionField(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
function updateDataCollectionField2() {
  const payload = {};
  const getRequestOptions = updateDataCollectionField(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
function deleteDataCollectionField2() {
  const payload = {};
  const getRequestOptions = deleteDataCollectionField(payload);
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
    return url;
  };
...
export {
  createDataCollection2 as createDataCollection,
  createDataCollectionField2 as createDataCollectionField,
  deleteDataCollection2 as deleteDataCollection,
  deleteDataCollectionField2 as deleteDataCollectionField,
  getDataCollection2 as getDataCollection,
  listDataCollections2 as listDataCollections,
  restoreDataCollection2 as restoreDataCollection,
  updateDataCollection2 as updateDataCollection,
  updateDataCollectionField2 as updateDataCollectionField
};
