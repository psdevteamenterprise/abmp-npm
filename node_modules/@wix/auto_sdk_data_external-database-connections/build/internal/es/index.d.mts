...
interface GetExternalDatabaseConnectionSignature {
     ...
     */
    (name: string): Promise<NonNullablePaths<ExternalDatabaseConnection, `name` | `connectionStatus.successful` | `connectionStatus.causeOfFailure` | `connectionStatus.hasCollections` | `capabilities.collectionModificationsSupported` | `capabilities.fieldTypes`, 3>>;
}
...
interface ListExternalDatabaseConnectionsSignature {
     ...
     */
    (options?: ListExternalDatabaseConnectionsOptions): Promise<NonNullablePaths<ListExternalDatabaseConnectionsResponse, `externalDatabaseConnections` | `externalDatabaseConnections.${number}.name` | `externalDatabaseConnections.${number}.connectionStatus.successful` | `externalDatabaseConnections.${number}.connectionStatus.causeOfFailure` | `externalDatabaseConnections.${number}.connectionStatus.hasCollections` | `externalDatabaseConnections.${number}.capabilities.collectionModificationsSupported`, 5>>;
}
...
interface CreateExternalDatabaseConnectionSignature {
     ...
     */
    (externalDatabaseConnection: NonNullablePaths<ExternalDatabaseConnection, `name`, 2>, connectionType: ConnectionTypeWithLiterals): Promise<NonNullablePaths<ExternalDatabaseConnection, `name` | `connectionStatus.successful` | `connectionStatus.causeOfFailure` | `connectionStatus.hasCollections` | `capabilities.collectionModificationsSupported` | `capabilities.fieldTypes`, 3>>;
}
...
interface UpdateExternalDatabaseConnectionSignature {
     ...
     */
    (name: string, externalDatabaseConnection: UpdateExternalDatabaseConnection): Promise<NonNullablePaths<ExternalDatabaseConnection, `name` | `connectionStatus.successful` | `connectionStatus.causeOfFailure` | `connectionStatus.hasCollections` | `capabilities.collectionModificationsSupported` | `capabilities.fieldTypes`, 3>>;
}
