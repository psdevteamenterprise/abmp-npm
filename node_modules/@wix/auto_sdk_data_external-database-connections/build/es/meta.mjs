...
function getExternalDatabaseConnection2() {
  ...
  const getRequestOptions = getExternalDatabaseConnection(
    payload
  );
...
function listExternalDatabaseConnections2() {
  const payload = {};
  const getRequestOptions = listExternalDatabaseConnections(
    payload
  );
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
...
function createExternalDatabaseConnection2() {
  const payload = {};
  const getRequestOptions = createExternalDatabaseConnection(
    payload
  );
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
...
function updateExternalDatabaseConnection2() {
  const payload = {
    externalDatabaseConnection: { name: ":externalDatabaseConnectionName" }
  };
  const getRequestOptions = updateExternalDatabaseConnection(
    payload
  );
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
...
function deleteExternalDatabaseConnection2() {
  const payload = { name: ":name" };
  const getRequestOptions = deleteExternalDatabaseConnection(
    payload
  );
  const getUrl = (context) => {
    const { url } = getRequestOptions(context);
...
export {
  createExternalDatabaseConnection2 as createExternalDatabaseConnection,
  deleteExternalDatabaseConnection2 as deleteExternalDatabaseConnection,
  getExternalDatabaseConnection2 as getExternalDatabaseConnection,
  listExternalDatabaseConnections2 as listExternalDatabaseConnections,
  updateExternalDatabaseConnection2 as updateExternalDatabaseConnection
};
